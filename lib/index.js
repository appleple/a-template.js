...
var aTemplate = function () {
  ...
  _createClass(aTemplate, [{
    ...
    value: function resolveBlock(html, item, i) {
      var that = this;
      var touchs = html.match(/<!-- BEGIN ([a-zA-Z0-9._-ぁ-んァ-ヶ亜-熙]+):touch#([a-zA-Z0-9._-ぁ-んァ-ヶ亜-熙]+) -->/g);
      var touchnots = html.match(/<!-- BEGIN ([a-zA-Z0-9._-ぁ-んァ-ヶ亜-熙]+):touchnot#([a-zA-Z0-9._-ぁ-んァ-ヶ亜-熙]+) -->/g);
      var exists = html.match(/<!-- BEGIN ([a-zA-Z0-9._-ぁ-んァ-ヶ亜-熙]+):exist -->/g);
      var empties = html.match(/<!-- BEGIN ([a-zA-Z0-9._-ぁ-んァ-ヶ亜-熙]+):empty -->/g);
      /*タッチブロック解決*/
      if (touchs) {
      ...
      if (touchnots) {
        for (var _k = 0, _n = touchnots.length; _k < _n; _k++) {
          ...
          _start = _start.replace(/([a-zA-Z0-9._-ぁ-んァ-ヶ亜-熙]+):touchnot#([a-zA-Z0-9._-ぁ-んァ-ヶ亜-熙]+)/, "($1):touchnot#($2)");
      ...
      if (exists) {
        for (var _k2 = 0, _n2 = exists.length; _k2 < _n2; _k2++) {
          ...
          _start2 = _start2.replace(/([a-zA-Z0-9._-ぁ-んァ-ヶ亜-熙]+):exist/, "($1):exist");
      ...
      if (empties) {
        for (var _k3 = 0, _n3 = empties.length; _k3 < _n3; _k3++) {
          ...
          _start3 = _start3.replace(/([a-zA-Z0-9._-ぁ-んァ-ヶ亜-熙]+):empty/, "($1):empty");
    ...
    value: function resolveWith(html) {
      var width = /<!-- BEGIN ([a-zA-Z0-9._-ぁ-んァ-ヶ亜-熙]+):with -->(([\n\r\t]|.)*?)<!-- END ([a-zA-Z0-9._-ぁ-んァ-ヶ亜-熙]+):with -->/g;
