...
var aTemplate = function () {
  function aTemplate(opt) {
    ...
    for (var i = 0, n = length; i < n; i += 1) {
      ...
      var templateEl = (0, _util.selector)('#' + template);
      var html = templateEl ? templateEl.innerHTML : '';
  ...
  _createClass(aTemplate, [{
    ...
    value: function update() {
      ...
      var _loop = function _loop(i, n) {
        ...
        if (!target) {
          var anchor = (0, _util.selector)(query);
          if (anchor) {
            anchor.insertAdjacentHTML('afterend', '<div data-id="' + tem + '"></div>');
            target = (0, _util.selector)('[data-id=\'' + tem + '\']');
            if (renderWay === 'text') {
        ...
        if (target) {
          ...
          if (!template.binded) {
            ...
            _this5.addDataBind(target);
            _this5.addActionBind(target);
          }
        }
      };
