...
(0, _zeptoBrowserify.$)(document).on("input change click", "[data-bind]", function (e) {
    ...
    var data = (0, _zeptoBrowserify.$)(this).data("bind");
    var val = (0, _zeptoBrowserify.$)(this).val();
    var attr = (0, _zeptoBrowserify.$)(this).attr("href");
    if (attr) {
        val = attr.replace("#", "");
    }
    var id = (0, _zeptoBrowserify.$)(this).parents("[data-id]").data("id");
    if (id) {
        var obj = getObjectById(id);
        if ((0, _zeptoBrowserify.$)(e.target).attr("type") == "radio") {
            if ((0, _zeptoBrowserify.$)(this).is(":checked")) {
                obj.updateDataByString(data, val);
            } else {
                obj.updateDataByString(data, '');
            }
        } else if ((0, _zeptoBrowserify.$)(e.target).attr("type") == "checkbox") {
            var name = (0, _zeptoBrowserify.$)(this).attr("name");
            var arr = [];
            (0, _zeptoBrowserify.$)(":checkbox[name=" + name + "]").each(function () {
                if ((0, _zeptoBrowserify.$)(_this).is(":checked")) {
                    arr.push((0, _zeptoBrowserify.$)(_this).val());
                }
            });
...
(0, _zeptoBrowserify.$)(document).on("input click change keydown", "[data-action]", function (e) {
    ...
    var string = (0, _zeptoBrowserify.$)(this).data("action");
